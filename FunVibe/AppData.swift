...
var bookClub:Club = Club(
    ...
    description: "Lisez des livres fascinants et partagez vos réflexions.",
...
var eventComedyShow:Event = Event(
    ...
    description: "Assistez à un spectacle d'humour en plein air!",
...
var majongInterest: Interest = Interest(
    ...
    description: "Défiez vos amis pour une partie de mahjong amusante!",
    image: "mahjong-image",
    type: .interest,
    organiser: martha,
